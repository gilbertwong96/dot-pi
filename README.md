...
| `vision-fallback.ts`    | Auto-switch to a vision model when images enter the session, then switch back          | Vision-capable fallback models (e.g. `ollama-cloud/kimi-k2.7-code`, `minimax/MiniMax-M3`)              |
